  ...
  context "question is not essay" do
    ...
    it "renders results table content" do
      ...
      page.find("#question_#{question.id}_results_table") do |table|
        expect(table).to have_css "#option_#{option_yes.id}_result", text: "2 (40.0%)", normalize_ws: true
        expect(table).to have_css "#option_#{option_no.id}_result", text: "2 (40.0%)", normalize_ws: true
        expect(table).to have_css "#option_#{option_other.id}_result", text: "1 (20.0%)", normalize_ws: true
